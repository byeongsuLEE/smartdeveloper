	    	...
	    	<form id="frm">
	    		...
	    		<input type = "hidden" name="keyword" value ="${cri.keyword}"/>
						...
						<div class="form-group">
							...
							<input type="text" value= "<c:out value='${vo.title}'/>" readonly="readonly" class="form-control" placeholder="Enter title" name= "title">
						</div>
						<div class ="form-group">
						...
						<button type="button" data-oper="reply" class = "btn btn-sm info"   ${!empty m ? '' : "disabled='disabled'"}>답글</button>
